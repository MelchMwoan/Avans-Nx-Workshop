...
export class TrainingService {
    endpoint = environment.dataApiUrl + '/training';
    ...
    public read(id: string | null, options?: any): Observable<ITraining> {
        ...
        return this.http
            .get<ApiResponse<ITraining>>(this.endpoint + '/' + id, {
                ...options,
                ...httpOptions,
            })
            .pipe(
    ...
    public create(training: CreateTrainingDto, options?: any) {
        const authOptions = {
            ...httpOptions,
            headers: new HttpHeaders({
                'Content-type': 'application/json',
        ...
        return this.http
            .post<ApiResponse<ITraining>>(this.endpoint, training, {
                ...options,
                ...authOptions,
            })
            .pipe(
    ...
    public update(id: string, training: UpdateTrainingDto, options?: any) {
        ...
        return this.http
        .put<ApiResponse<ITraining>>(this.endpoint + "/" + id, training, {
            ...options,
            ...authOptions,
        })
        .pipe(
